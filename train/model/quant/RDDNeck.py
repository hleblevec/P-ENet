...
class RDDNeck(nn.Module):
    def __init__(self, dilation, in_channels, out_channels, down_flag, mode,relu, projection_ratio=4, weight_bit_width = 8, act_bit_width = 8):
        ...
        self.down = qnn.QuantConv2d(in_channels = self.in_channels,
